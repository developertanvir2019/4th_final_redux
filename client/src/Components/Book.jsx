...
import deleteThunk from '../redux/books/thunk/deletethunk';
import fetchBooks from '../redux/books/thunk/fetchBooks';

const Book = ({ book }) => {
    const dispatch = useDispatch()
    const handleDelete = () => {
        dispatch(deleteThunk(book?.id))
        dispatch(fetchBooks)
    }
    return (
        <div className="book-card">
            ...
            <div className="flex-1 h-full pr-2 pt-2 flex flex-col">
                <div className="flex items-center justify-between">
                    {book?.featured === true ? <span className="badge-success lws-Badge">featured</span> : <span></span>}
